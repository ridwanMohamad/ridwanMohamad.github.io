	...
	e.locale('en'),
		(t.fn[a] = function (e, a) {
			return (
				this.each(function () {
					t.data(this, s)
						? ('function' == typeof t.data(this, s)[e] &&
								t.data(this, s)[e](a),
		...
		(i.prototype = {
			...
			initTemplate: function () {
				(this.template =
					...
					t('body').find('#' + this.name).length <= 0 &&
						...
						this &&
							(this.dtpElement = t('body').find('#' + this.name)),
			...
			initDate: function (t) {
				(this.currentView = 0),
					...
					this.$dtpElement
						...
						.addClass('hidden');
				var e =
						'undefined' != typeof this.currentDate &&
						null !== this.currentDate
							? this.currentDate
							: null,
					i = this.generateCalendar(this.currentDate);
				if (
					'undefined' != typeof i.week &&
					'undefined' != typeof i.days
				) {
			...
			constructHTMLCalendar: function (t, i) {
				...
				for (var s = 0; s < i.days.length; s++)
					s % 7 == 0 && (a += '</tr><tr>'),
						...
						0 != i.days[s] &&
							((a +=
								this.isBeforeMaxDate(e(i.days[s]), !1, !1) ===
									!1 ||
			...
			_onNowClick: function () {
				if (
					...
					switch (
						(this.showTime(this.currentDate), this.currentView)
					) {
						case 1:
							this.initHours();
							break;
